<x-app-layout>
    ...
    <div class="font-poppins h-screen">
        <div class="flex flex-col md:ml-64 md:flex-row  bg-gray-100">
            ...
            <div
                ...
                <div class="flex-none">
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const adminusers = @json($adminusers); // Pass admin user emails from the server-side
                            ...
                            function populateDropdown(users) {
                                ...
                                users.forEach(user => {
                                    const email = user.email; // Access the email field
                                ...
                                console.log('Dropdown populated with emails');
                            }

                            input.addEventListener('focus', function() {
                                populateDropdown(adminusers); // Populate dropdown when input is focused
                    ...
                    @else
                        ...
                        <script>
                            function markAsRead(messageId) {
                                fetch(`/admin/messages/mark-as-read/${messageId}`, {
                        ...
                        @if (Route::currentRouteName() == 'admin.sentmessages')
                            <div id="editModal"
                ...
                <script>
                    ...
                    function deleteMessage(messageId) {
                        fetch(`/admin/destroymessages/${messageId}`, {
                                method: 'DELETE',
                                headers: {
                                    'Content-Type': 'application/json',
