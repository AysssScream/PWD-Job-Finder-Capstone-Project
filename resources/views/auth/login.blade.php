...
<footer class="bg-gray-200 dark:bg-gray-800 text-white w-full py-4 mt-12">
    <div class="container mx-auto text-center">
        <span class="text-gray-900 dark:text-gray-200">&copy; 2024 AccessiJobs. All rights reserved.</span>
    </div>
</footer>
