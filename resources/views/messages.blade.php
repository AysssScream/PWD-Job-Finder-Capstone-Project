            ...
            <div
                ...
                <div class="flex-none">
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const pwdUsers = @json($pwdUsers); // Pass admin user emails from the server-side
                            ...
                            input.addEventListener('focus', function() {
                                populateDropdown(pwdUsers); // Populate dropdown when input is focused
                    ...
                    @else
                        ...
                        <script>
                            function markAsRead(messageId) {
                                fetch(`/user/messages/mark-as-read/${messageId}`, {
                        ...
                        @if (Route::currentRouteName() == 'user.sentmessages')
                            <div id="editModal"
                ...
                <script>
                    ...
                    function deleteMessage(messageId) {
                        fetch(`/user/destroymessages/${messageId}`, {
                                method: 'DELETE',
                                headers: {
                                    'Content-Type': 'application/json',
