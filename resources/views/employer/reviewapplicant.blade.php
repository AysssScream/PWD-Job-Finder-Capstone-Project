    ...
    @if (Session::has('deleteapplication'))
        <script>
            $(document).ready(function() {
                ...
                toastr.error("{{ Session::get('deleteapplication') }}", 'Job Application Deleted.', {
                    timeOut: 5000
                });
            });
        </script>
    @endif
    @if (Session::has('setInterview'))
        <script>
            $(document).ready(function() {
                toastr.options = {
                    "progressBar": true,
                ...
                toastr.success("{{ Session::get('setInterview') }}", 'User Interview Notice Sent.', {
                    timeOut: 5000
                });
            });
        </script>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                <div class="p-4 md:p-6 space-y-4 md:space-y-6">
                    ...
                    <div
                        ...
                        <form id="filterForm" method="GET" action="{{ route('employer.review') }}">
                            <div
                                ...
                                <div class="p-6">
                                    <div class="space-y-4">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-300 flex items-center"
                                            ...
                                            {{ $application->remarks ? Str::limit($application->remarks, 30) : 'No Remarks Yet' }}
                                        </p>
                                        <p class="text-sm text-gray-600 dark:text-gray-300 flex items-center"
