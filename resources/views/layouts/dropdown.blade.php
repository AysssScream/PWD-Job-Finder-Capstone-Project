        ...
        <div class="container mx-auto px-6">
            ...
            <div class="mb-4 px-4 py-3 bg-white text-gray-800 dark:bg-gray-800 dark:text-gray-200 rounded-lg shadow-md">
                <p class="text-sm font-medium text-center">
                    Please complete all steps to finalize your profile setup. Remember to click the
                    <span
                    ...
                    button to save your personal records.
                </p>
            </div>
            ...
            <div class="flex justify-start mb-4">
                <button id="toggleButton"
                    ...
                    <i class="fas fa-bars"></i> Steps Involved
                </button>
            </div>
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('setup') }}"
                                ...
                                <span><i class="fas fa-user mr-2"></i> Step 1: Applicant Profile</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('personal') }}"
                                ...
                                <span><i class="fas fa-id-card mr-2"></i> Step 2: Personal Information</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('workexp') }}"
                                ...
                                <span><i class="fas fa-paper-plane mr-2"></i> Step 3: Employment History and Work
                                    Experience </span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('jobpreferences') }}"
                                ...
                                <span><i class="fas fa-gears mr-2"></i> Step 4: Job Preferences</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('dialect') }}"
                                ...
                                <span><i class="fas fa-language mr-2"></i> Step 5: Language Proficiency and Other
                                    Skills</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('educationalbg') }}"
                                ...
                                <span><i class="fas fa-graduation-cap mr-2"></i> Step 6: Educational Background</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('pwdinfo') }}"
                                ...
                                <span><i class="fas fa-wheelchair mr-2"></i> Step 7: Verify PWD Information</span>
                            </a>
                        </li>
