<h2 class="text-2xl font-bold mb-2 text-gray-800 dark:text-gray-100">APPLICANT PROFILE</h2>
...
<div class="mt-6">
    ...
    <x-text-input id="firstname" name="firstname" type="text" class="mt-1 block w-full" :value="old('firstname', $applicant->firstname ?? '')" required
...
<div class="mt-6">
    ...
    <x-text-input id="lastname" name="lastname" type="text" class="mt-1 block w-full" :value="old('lastname', $applicant->lastname ?? '')" required
        autocomplete="lastname" />
    <x-input-error class="mt-2" :messages="$errors->get('lastname')" />
</div>

<div class="mt-6">
    <label for="birthdate" class="block mb-1 text-gray-800 dark:text-gray-100">Birthdate</label>
    <x-text-input id="birthdate" name="birthdate" type="date"
        class="mt-1 block w-full text-gray-800 dark:text-gray-100" :value="old('birthdate', $applicant->birthdate ?? '')" required autocomplete="birthdate"
        readonly />
    @error('birthdate')
...
<div class="mt-6">
    <label for="suffix" class="block mb-1 text-gray-800 dark:text-gray-100">Suffix</label>
    <select id="suffix" name="suffix"
        class="w-full p-2 bg-gray-100 text-black dark:bg-gray-900 dark:text-gray-200 border-gray-500 rounded shadow-sm">
...
<div class="mt-6">
    <label for="gender" class="block mb-1 text-gray-800 dark:text-gray-100">Gender</label>
