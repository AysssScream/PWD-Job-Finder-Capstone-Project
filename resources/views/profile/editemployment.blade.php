            ...
            <div class="container mx-auto  ">
                <div class="flex justify-center">
                    <div class="w-5/6">
                        ...
                        <div class=" container-wrapper  bg-white shadow-md rounded-lg">
                            <div class="p-6">
                                <h3 class="text-2xl font-bold mb-2 inline-flex items-center justify-between w-full">
                                    Employment History and Work Experieence
                                </h3>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-6">
                                                ...
                                                <input type="text" id="positionHeld" name="positionHeld"
                                                    class="w-full p-2 border rounded" pattern="[A-Za-z\s]+"
                                            ...
                                            <div class="mt-6">
                                                ...
                                                <input type="text" id="skillSearch" name="skillSearch[]"
                                                    class="w-full p-2 border rounded" list="skillSuggestions"
                        ...
                        function loadData() {
                            ...
                            if (formDataJSON) {
                                ...
                                formDataArray.forEach(formData => {
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                        <div class="text-sm font-medium text-gray-900">${formData.employerName}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                        <div class="text-sm text-gray-900">${formData.employerAddress}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                        <div class="text-sm text-gray-900">${formData.positionHeld}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                        <div class="text-sm text-gray-900">${formData.skillSearch}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                        <div class="text-sm text-gray-900">${formData.fromDate}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                        <div class="text-sm text-gray-900">${formData.toDate}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                        <div class="text-sm text-gray-900">${formData.employmentStatus}</div>
                                    </td>
                                `;
