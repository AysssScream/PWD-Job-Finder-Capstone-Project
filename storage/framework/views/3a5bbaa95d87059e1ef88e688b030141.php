                            ...
                            <div class="p-6">
                                ...
                                <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <div class="mt-6">
                                            <label for="lastname"
                                                class="block mb-1"><?php echo e(__('messages.applicant.lastname')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-6">
                                            <label for="firstname"
                                                class="block mb-1"><?php echo e(__('messages.applicant.firstname')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-6">
                                            <label for="birthdate"
                                                class="block mb-1"><?php echo e(__('messages.applicant.birthdate')); ?></label>
