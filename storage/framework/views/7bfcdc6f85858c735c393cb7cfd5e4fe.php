...
<?php $component->withAttributes([]); ?>
    ...
    <body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        ...
        <main class="max-w-8xl mx-auto px-3 sm:px-1 lg:px-1 py-20 flex flex-wrap gap-4 lg:ml-12">
            ...
            <?php echo $__env->make('dashboardpartials.matchedjobs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </main>
    </body>
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views\matchedjobs.blade.php ENDPATH**/ ?>