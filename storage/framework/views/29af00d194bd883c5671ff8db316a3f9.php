  ...
  <section>
      <header>
          <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
              <?php echo e(__('Update Profile Picture')); ?>

          </h2>

          <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
              <?php echo e(__('Ensure you upload appropriate profile pictures and smaller sizes.')); ?>
      ...
      <form method="post" action="<?php echo e(route('password.passupdate')); ?>" class="mt-6 space-y-6">
          ...
          <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
              <?php echo e(__('Ensure you upload appropriate profile pictures and smaller sizes (2MB).')); ?>
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views\profile\partials\update-profile-pic.blade.php ENDPATH**/ ?>