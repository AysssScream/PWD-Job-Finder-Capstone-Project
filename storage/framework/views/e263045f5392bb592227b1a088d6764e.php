            ...
            <div
                ...
                <div class="flex-none">
                                ...
                                <div
                                    ...
                                    <div class="sm:items-start">
                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div class="mt-2">
                                                <form action="<?php echo e(route('admin.messages.store')); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="mb-4">
                                                        <label for="to"
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('admin.sentmessages')); ?>"
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 dark:hover:bg-gray-800 rounded-lg transition duration-150 ease-in-out">
                            <svg class="w-5 h-5 mr-2 text-gray-700 dark:text-gray-200" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="container mx-auto">
                    ...
                    <h1 class="text-2xl font-bold mb-4 p-4">
                        <?php if($currentRoute == 'admin.messages'): ?>
                            Messages
                        <?php elseif($currentRoute == 'admin.sentmessages'): ?>
                            Sent Messages
                        <?php else: ?>
                            Messages
                        <?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="messages-list overflow-y-auto h-screen"> <!-- Added classes for scrollable area -->
                            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="email-item p-4 border-b border-gray-400 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                                    ...
                                    data-to="<?php echo e($message->to); ?>" onclick="showAdminReplies(<?php echo e($message->id); ?>)">
                        ...
                        <div id="replyModal"
                            ...
                            <div
                                ...
                                <div class="p-6">
                                    <form id="replyForm" action="<?php echo e(route('admin.replies.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views/admin/messages.blade.php ENDPATH**/ ?>