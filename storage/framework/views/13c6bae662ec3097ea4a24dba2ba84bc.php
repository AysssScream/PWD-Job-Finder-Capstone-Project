...
<?php endif; ?>
    <form method="POST" action="<?php echo e(route('password.passemail')); ?>">
        <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['id' => 'reset-password-btn']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reset-password-btn']); ?>
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>