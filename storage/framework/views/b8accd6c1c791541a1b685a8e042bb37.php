...
<body>
    <div class="py-36 bg-cover bg-center">
        ...
        <?php else: ?>
            <?php if(Auth::check() && Auth::user()->account_verification_status === 'waiting for approval'): ?>
            ...
            <?php elseif(Auth::check() && Auth::user()->account_verification_status === 'pending'): ?>
                <div class="landscape-container mt-15">
                    <div class="container w-3/4 mx-auto landscape-content">
                        <div
                            class="bg-white text-black dark:bg-gray-700 dark:text-gray-200 p-6 rounded-lg shadow-md text-center">
                            ...
                            <form action="<?php echo e(route('pendingapproval')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views/layouts/pendingapproval.blade.php ENDPATH**/ ?>