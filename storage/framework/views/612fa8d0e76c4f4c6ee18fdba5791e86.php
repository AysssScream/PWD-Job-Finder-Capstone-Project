            ...
            <div
                ...
                <div class="flex-none">
                                ...
                                <div
                                    ...
                                    <div class="sm:items-start">
                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div class="mt-2">
                                                <form action="<?php echo e(route('employer.messages.store')); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="mb-4">
                                                        <label for="to"
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('employer.messages')); ?>"
                        ...
                        <a href="<?php echo e(route('employer.sentmessages')); ?>"
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 dark:hover:bg-gray-800 rounded-lg transition duration-150 ease-in-out">
                            <svg class="w-5 h-5 mr-2 text-gray-700 dark:text-gray-200" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="container mx-auto">
                    ...
                    <h1 class="text-2xl font-bold mb-4 p-4">
                        <?php if($currentRoute == 'employer.messages'): ?>
                            Messages
                        <?php elseif($currentRoute == 'employer.sentmessages'): ?>
                            Sent Messages
                        <?php else: ?>
                            Messages
                        <?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        <div id="replyModal"
                            ...
                            <div
                                ...
                                <div class="p-6">
                                    <form id="replyForm" action="<?php echo e(route('employer.replies.store')); ?>"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views\employer\messages.blade.php ENDPATH**/ ?>