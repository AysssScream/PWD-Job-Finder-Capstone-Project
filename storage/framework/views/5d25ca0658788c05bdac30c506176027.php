        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($video->video_id && $video->location === 'Dashboard'): ?>
                        <?php
                        ...
                        ?>
                        <img class="w-full h-32 sm:h-48 object-cover" src="<?php echo e($thumbnailUrl); ?>" alt="Video Thumbnail">
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if(!$hasDashboardVideos): ?>
                ...
                <div class="p-4">
                    ...
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($video->location === 'Dashboard'): ?>
                            <?php if($video->video_id): ?>
                                <!-- Display the saved URL if video_id exists -->
                                <p class="text-sm text-gray-800 dark:text-gray-200 mb-4 mt-4">
                                    Saved URL: <a href="https://www.youtube.com/watch?v=<?php echo e($video->video_id); ?>"
                                        class="text-blue-500 hover:underline"
                                        target="_blank"><?php echo e('https://www.youtube.com/watch?v=' . $video->video_id); ?></a>
                                </p>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($video->video_id && $video->location === 'Saved Jobs'): ?>
                        <?php
                            // Set the flag to true
                ...
                <div class="p-4">
                    ...
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($video->location === 'Saved Jobs'): ?>
                            <?php if($video->video_id): ?>
                                <!-- Display the saved URL if video_id exists -->
                                <p class="text-sm text-gray-800 dark:text-gray-200 mb-4 mt-4">
                                    Saved URL: <a href="https://www.youtube.com/watch?v=<?php echo e($video->video_id); ?>"
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($video->video_id && $video->location === 'Settings'): ?>
                        <?php
                            // Set the flag to true
                ...
                <div class="p-4">
                    ...
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($video->location === 'Settings'): ?>
                            <?php if($video->video_id): ?>
                                <!-- Display the saved URL if video_id exists -->
                                <p class="text-sm text-gray-800 dark:text-gray-200 mb-4 mt-4">
                                    Saved URL: <a href="https://www.youtube.com/watch?v=<?php echo e($video->video_id); ?>"
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($video->video_id && $video->location === 'Job Information'): ?>
                        <?php
                            // Set the flag to true
                ...
                <?php if(!$hasJobInformationVideos): ?>
                    <img class="w-full h-32 sm:h-48 object-cover" src="https://via.placeholder.com/400x300"
                        alt="Video Thumbnail">
                <?php endif; ?>
                ...
                <div class="p-4">
                    ...
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($video->location === 'Job Information'): ?>
                            <?php if($video->video_id): ?>
                                <!-- Display the saved URL if video_id exists -->
                                <p class="text-sm text-gray-800 dark:text-gray-200 mb-4 mt-4">
                                    Saved URL: <a href="https://www.youtube.com/watch?v=<?php echo e($video->video_id); ?>"
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                ?>
                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($video->video_id && $video->location === 'Welcome Page'): ?>
                        <?php
                            // Set the flag to true
                ...
                <div class="p-4">
                    ...
                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($video->location === 'Welcome Page'): ?>
                            <?php if($video->video_id): ?>
                                <!-- Display the saved URL if video_id exists -->
                                <p class="text-sm text-gray-800 dark:text-gray-200 mb-4 mt-4">
                                    Saved URL: <a href="https://www.youtube.com/watch?v=<?php echo e($video->video_id); ?>"
    ...
    <div id="modal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 hidden">
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-md w-1/2">
            ...
            <form id="video-form" action="" method="post">
                <?php echo csrf_field(); ?> <!-- Include this if you're using Laravel and want to handle CSRF protection -->
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="text-red-500 text-sm mt-1 mb-1"><?php echo e($message); ?></div>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <script defer>
        function openModal(location) {
            ...
            var actionUrl = `<?php echo e(route('admin.video.store', ':location')); ?>`.replace(':location', encodeURIComponent(
                location));
    ...
    <?php if(Session::has('addvideo')): ?>
        <script>
            $(document).ready(function() {
                ...
                toastr.success("<?php echo e(Session::get('addvideo')); ?>", 'Video Saved', {
                    timeOut: 5000
                });
            });
        </script>
    ...
    <?php if(Session::has('updatevideo')): ?>
        <script>
            $(document).ready(function() {
                toastr.options = {
                    "progressBar": true,
                ...
                toastr.success("<?php echo e(Session::get('updatevideo')); ?>", 'Video Updated', {
                    timeOut: 5000
                });
            });
        </script>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views/admin/managevideos.blade.php ENDPATH**/ ?>