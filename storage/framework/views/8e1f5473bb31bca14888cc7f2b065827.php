    ...
    <div class="font-poppins h-screen">
        <div class="flex flex-col md:flex-row  bg-gray-100">
            ...
            <div
                ...
                <div class="flex-none">
                    <!-- Go Back Button -->
                    <?php if(Auth::user()->account_verification_status == 'declined' && Auth::user()->usertype == 'user'): ?>
                        <div class="p-4 border-b border-gray-400">
                            <a href="<?php echo e(route('pendingapproval')); ?>"
                                ...
                                <div
                                    ...
                                    <div class="sm:items-start">
                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div class="mt-2">
                                                <form action="<?php echo e(route('user.messages.store')); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="mb-4">
                                                        <label for="to"
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const users = <?php echo json_encode($users->pluck('email'), 15, 512) ?>; // Pass the email list from your server-side
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('user.sentmessages')); ?>"
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 dark:hover:bg-gray-800 rounded-lg transition duration-150 ease-in-out">
                            <svg class="w-5 h-5 mr-2 text-gray-700 dark:text-gray-200" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="container mx-auto">
                    ...
                    <h1 class="text-2xl font-bold mb-4 p-4">
                        <?php if($currentRoute == 'user.messages'): ?>
                            Messages
                        <?php elseif($currentRoute == 'user.sentmessages'): ?>
                            Sent Messages
                        <?php else: ?>
                            Messages
                        <?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="messages-list overflow-y-auto h-screen">
                            ...
                            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="email-item p-4 border-b border-gray-400 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                                    data-id="<?php echo e($message->id); ?>" data-from="<?php echo e($message->from); ?>"
                                    data-subject="<?php echo e($message->subject); ?>" data-message="<?php echo e($message->message); ?>"
                                    data-created-at="<?php echo e($message->created_at->format('g:i A')); ?>"
                                    data-to="<?php echo e($message->to); ?>" onclick="showReplies(<?php echo e($message->id); ?>)">

                                    <div class="flex items-center mb-1">
                                        <div
                                            class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold mr-1">
                                            <?php echo e(substr($message->from, 0, 1)); ?>

                                        </div>
                                        <h3 class="font-semibold text-sm text-gray-700 dark:text-gray-200">
                                            <?php echo e($message->from); ?></h3>
                                    </div>
                                    <h4 class="text-md font-medium text-gray-700 dark:text-gray-200">
                                        <?php echo e($message->subject); ?></h4>
                                    ...
                                    <span class="ml-auto text-xs text-gray-700 dark:text-gray-200">
                                        <?php echo e($message->created_at->setTimezone('Asia/Singapore')->format('g:i A')); ?>
                        ...
                        <div id="replyModal"
                            ...
                            <div
                                ...
                                <div class="p-6">
                                    <form id="replyForm" action="<?php echo e(route('user.replies.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views\messages.blade.php ENDPATH**/ ?>