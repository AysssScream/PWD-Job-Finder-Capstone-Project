                        ...
                        <?php if(Route::has('login')): ?>
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <?php elseif(Auth::user()->usertype == 'employer'): ?>
                                    <a href="<?php echo e(route('employer.dashboard')); ?>" class="btn btn-custom-login" role="button"
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views/contactpage.blade.php ENDPATH**/ ?>