                                    ...
                                    <div>
                                        <div class="mt-6">
                                            <label for="civilStatus"
                                                class="block mb-1"><?php echo e(__('messages.personal.civil_status')); ?> <i
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div id="barangay-container" class="mt-6">
                                            <label for="barangay" class="block mb-1">
                                                <?php echo e(__('messages.personal.barangay')); ?> <i
                                                    class="fas fa-asterisk text-red-500 text-xs"></i>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-6">
                                            <label for="zipcode"
                                                class="block mb-1"><?php echo e(__('messages.personal.zipcode')); ?> <i
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-6">
                                            <label for="presentAddress"
                                                class="block mb-1"><?php echo e(__('messages.personal.present_address')); ?> <i
                                                    class="fas fa-asterisk text-red-500 text-xs"></i>
                                            </label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-6">
                                            <label class="block mb-2 "><?php echo e(__('messages.personal.4ps_beneficiary')); ?>
