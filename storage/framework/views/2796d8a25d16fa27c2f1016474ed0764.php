                                    ...
                                    <div class="mt-6">
                                        <div class="flex flex-col mr-4 w-full ">
                                            <label for="disabilityOccurrence"
                                                class="block mb-1"><?php echo e(__('messages.pwdinfo.disability_occurrence.label')); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <label for="fileUpload" class="block mb-1 mt-6">
                                            <?php echo e(__('messages.pwdinfo.upload_pwd_id')); ?> <i
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-6">
                                    <label class="block mb-2 "><?php echo e(__('messages.pwdinfo.disability_status')); ?> <i
                                            class="fas fa-asterisk text-red-500 text-xs"></i></label>
                                    <div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div id="disabilityTextBox"
                                        ...
                                        <label class="block mb-2">
                                            <?php echo e(__('messages.pwdinfo.specify_disability')); ?> <i
                                                class="fas fa-asterisk text-red-500 text-xs"></i></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="bg-white text-black dark:bg-gray-800 dark:text-gray-200 shadow-md rounded-lg mt-4 p-6">
                        <h3 class="text-xl sm:text-lg md:text-xl lg:text-3xl font-bold mb-2 focus:outline-none focus:ring-4 focus:ring-orange-400 focus:border-orange-400 break-words"
                            ...
                            <?php echo e(__('messages.pwdinfo.certification_authorization')); ?> <i
                                class="fas fa-asterisk text-red-500 text-lg mb-2"></i>
                        </h3>
