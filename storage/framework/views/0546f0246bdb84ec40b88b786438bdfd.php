 <section class=" w-full lg:w-4/5 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 ">
     ...
     <body x-data="{ showResumeTemplateModal: false }">
         <form id="resumeUploadForm" action="<?php echo e(route('resume.uploadresults')); ?>" method="POST"
         ...
         <?php if(isset($data)): ?>
             <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg shadow-3d shadow-lg mb-4">
                 <p class="text-gray-700 dark:text-gray-200"><strong>Education:</strong> <?php echo e($data['education']); ?></p>
                 <br>
                 <p class="text-gray-700 dark:text-gray-200"><strong>Age:</strong> <?php echo e($data['age'] ?? 'N/A'); ?></p>
                 <br>
                 <p class="text-gray-700 dark:text-gray-200"><strong>Skills:</strong> <?php echo e($data['skills'] ?? 'N/A'); ?>

                 </p>
                 <br>
                 <p class="text-gray-700 dark:text-gray-200"><strong>File name:</strong>
                     <?php echo e($data['filename'] ?? 'N/A'); ?>

                 </p>
                 <br>
             </div>
         <?php elseif(isset($resume)): ?>
             <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg shadow-3d shadow-lg mb-4">
                 <p class="text-gray-700 dark:text-gray-200"><strong>Education:</strong> <?php echo e($resume->education); ?></p>
                 <br>
                 <p class="text-gray-700 dark:text-gray-200"><strong>Age:</strong> <?php echo e($resume->age ?? 'N/A'); ?></p>
                 <br>
                 <p class="text-gray-700 dark:text-gray-200"><strong>Skills:</strong> <?php echo e($resume->skills ?? 'N/A'); ?>

                 </p>
                 <br>
                 <p class="text-gray-700 dark:text-gray-200"><strong>File name:</strong>
                     <?php echo e($resume->file_name ?? 'N/A'); ?>
         ...
         <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
             <?php if($matchedResumeJobs->isEmpty()): ?>
                 <div
             ...
             <?php else: ?>
                 <?php $__currentLoopData = $matchedResumeJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         ...
                         <div ta bindex="0"
                             ...
                             <div
                                 class="flex justify-center p-4 rounded-lg mb-4 
                                    <?php if(isset($job->match_reasons['skills']) && count($job->match_reasons['skills']) > 0): ?> bg-green-600 dark:bg-green-500 
                                    <?php else: ?> bg-yellow-600 <?php endif; ?>">
                                 <div class="text-center">
                                     <ul class="list-disc list-inside text-white">
                                         <ul>
                                             <?php if(isset($job->match_reasons['education']) && count($job->match_reasons['education']) > 0): ?>
                                                 <li><strong>Matched Education:</strong>
                                                     <?php echo e(implode(', ', $job->match_reasons['education'])); ?>

                                                     (<?php echo e($job->match_percentages['education'] ?? '0%'); ?>)
                                                     Matched
                                                 </li>
                                             <?php endif; ?>

                                             <?php if(isset($job->match_reasons['skills']) && count($job->match_reasons['skills']) > 0): ?>
                                                 <?php
                                                     $maxSkillsToShow = 2;
                                                 ...
                                                 <li><strong>Matched Skill:</strong>
                                                     (<?php echo e(implode(', ', $skillsToShow)); ?><?php echo e($remainingSkills > 0 ? ', ...' : ''); ?>)
                                                     <?php echo e($job->match_percentages['skills'] ?? '0%'); ?>
                                             ...
                                             <?php if(isset($job->match_reasons['age']) && count($job->match_reasons['age']) > 0): ?>
                                                 <li><strong>Matched Age:</strong>
                                                     <?php echo e(implode(', ', $job->match_reasons['age'])); ?>

                                                     (<?php echo e($job->match_percentages['age'] ?? '0%'); ?>) Matched
                                                 </li>
                                             <?php endif; ?>
                                         </ul>
                                     </ul>
             ...
             <div x-show="showResumeTemplateModal" x-transition:enter="ease-out duration-300"
                 ...
                 <div class="bg-gray-300 dark:bg-gray-800 h-max px-4 pt-5 pb-4 sm:p-6 sm:pb-4 ">
                     <div class="bg-gray-100 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                         ...
                         <a href="<?php echo e(route('download.docx')); ?>"
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views\dashboardpartials\uploadresume.blade.php ENDPATH**/ ?>