...
<head>
    ...
    <link rel="preload" href="<?php echo e(asset('/css/Homepage.css')); ?>" as="style" rel='stylesheet'>
                        ...
                        <div class="lc-block ms-auto d-grid gap-2 d-lg-block">
                            <?php if(Route::has('login')): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="btn btn-custom-login" role="button"
                                        aria-label="Login">
                                        <i class="fas fa-sign-in-alt"></i> LOG IN
                                    </a>

                                    <?php if(Route::has('register')): ?>
                                        <a href="<?php echo e(route('register')); ?>" class="btn btn-custom-signup" role="button"
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views/faq.blade.php ENDPATH**/ ?>