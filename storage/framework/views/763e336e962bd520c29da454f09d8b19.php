            ...
            <div id="barangay-container" class="mt-6 relative">
                ...
                <div class="flex items-center">
                    <input id="barangay" type="text" name="barangay" class="w-full p-2 border rounded shadow-sm"
                        ...
                        value="<?php echo e(old('barangay', $personal->barangay ?? '')); ?>" readonly>
            ...
            <div class="mt-6">
                ...
                <div class="flex items-center mt-4">
                    <input type="text" id="zipcode" name="zipcode" class="w-full p-2 border rounded"
                        value="<?php echo e(old('zipcode', $personal->zipCode ?? '')); ?>" placeholder="Enter Zip Code" readonly />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6">
                    ...
                    <input type="tel" id="cellphoneNo" name="cellphoneNo" class="w-full p-2 border rounded"
                        ...
                        maxlength="11" value="<?php echo e(old('cellphoneNo', $personal->cellphoneNo ?? '')); ?>" />
                ...
                <div id="ofw-country-details" class="mt-6">
                    ...
                    <div class="flex items-center relative">
                        <input type="text" id="ofw-country" name="ofw-country"
                            ...
                            value="<?php echo e(old('ofw-country', $personal->ofw_country ?? '')); ?>"
...
<?php endif; ?>
                    ...
                    <?php if(session('status') === 'profile-updated'): ?>
                        <p x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 2000)"
                            class="text-md font-semibold text-green-400 dark:text-gray-400"><?php echo e(__('Saved.')); ?></p>
                    <?php endif; ?>
                </div>
...
<?php /**PATH C:\xampp\htdocs\finalproj\resources\views\profile\partials\personal-information.blade.php ENDPATH**/ ?>